...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $EN = isset($_POST['EN']) ? trim($_POST['EN']) : '';
    ...
    elseif (!checkPasswordStrength($password)) {
        ...
        try {
            ...
            if ($stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                $stmt = $conn->prepare("INSERT INTO admintb (username, nic, empId,  password) VALUES (:username, :NIC, :EN, :password )");
                $stmt->bindParam(':username', $username);
	...
	<div class="wrapper">
		<form action="adminRegister.php" method="POST">
			...
			<div class="input-box">
				...
				<input type="text" id="EN" name="EN" placeholder="Employee Number" required>
			...
			<div class="register-link">
				<p>have an account? <a href="admin.php" target="_blank">Sign in</a> </p>
			</div>
